    ...
    <body>
     ...
     %>
            <div class="row">
                <div class="row">
                <div class="col-8">
                <h1>Operadores asignados a la tarea <%=idTarea%></h1>
                </div>
                <div class="col-4">
                 <a href="agregarAdminOperario.jsp?idTarea=<%=idTarea%>" class="btn btn-success">Agregar operador</a>
                </div>
                </div>
                <br>
                        ...
                        <table class="table table-hover  table-responsive table-bordered border-dark col-sm-18 display" id="myTable" border="5">
                            ...
                            <tbody>
                                <%
                                    ...
                                    List<DatosOperador> list = dao.listarOperariosTarea(idTarea);
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger"  href="Administrador1?accion=eliminarOperadorAdmin&idTarea=<%=idTarea%>&idOperario=<%=alu.getIdOper()%>">Eliminar</a>
